...
public class Device4SubConfig extends JFrame {
	...
	JLabel title = new JLabel("Device 4 Subscription");
	...
	public Device4SubConfig(Data myDataIn, Result resultIn) {
		...
		subBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ae) {
				...
				JOptionPane.showMessageDialog(null, "Device 4 Subscriber Successfully Configured: ", "MESSAGE",
