...
public class Device2SubConfig extends JFrame {
	...
	JLabel title = new JLabel("Device 2 Subscription");
	...
	public Device2SubConfig(Data myDataIn, Result resultIn) {
		...
		subBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ae) {
				...
				JOptionPane.showMessageDialog(null, "Device 2 Subscriber Successfully Configured: ", "MESSAGE",
