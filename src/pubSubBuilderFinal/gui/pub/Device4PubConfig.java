 ...
 * @author Yash Divecha
 */
public class Device4PubConfig extends javax.swing.JFrame {
	...
	/**
	 * Creates new form Device4Config
	 */
	public Device4PubConfig(Data myDataIn, Result resultIn) {
				...
				.addGroup(layout.createSequentialGroup()
						.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								...
								.addGroup(layout.createSequentialGroup().addGap(49, 49, 49)
										...
										.addGap(83, 83, 83).addComponent(jButton2)))
						.addContainerGap(267, Short.MAX_VALUE)));
		layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(layout.createSequentialGroup().addGap(81, 81, 81).addComponent(jLabel1).addGap(311, 311, 311)
	...
	private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton2ActionPerformed
		...
		result.setDevice4PublishersSelected(publisherSelected);
		result.setDevice4SelectedTopics(topicsPubSelected);
		result.setDevice4PubConfigured(true);
		JOptionPane.showMessageDialog(null, "Device 4 Publisher Successfully Configured: ", "MESSAGE",
				JOptionPane.INFORMATION_MESSAGE);
	}// GEN-LAST:event_jButton2ActionPerformed

	private void createCheckbox() {

		// noOfTopics = mongo.getCountCollection("topicSpace");
		
		topicCheckBox = new ArrayList<>();

		ArrayList<String> device4Topics = myData.getDevice4Data();
		...
		int i = 0;
		for (i = 0; i < device4Topics.size(); i++) {
			javax.swing.JCheckBox box = new javax.swing.JCheckBox(device4Topics.get(i));
